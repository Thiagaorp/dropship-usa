...
import {
  LayoutDashboard, Package, ShoppingBag, Search, LogOut, ChevronRight, Mail, Star, Users, Tag, ShoppingCart,
} from "lucide-react";
...
const navItems = [
  ...
  { href: "/admin/abandoned", label: "Abandoned Carts", icon: ShoppingCart },
